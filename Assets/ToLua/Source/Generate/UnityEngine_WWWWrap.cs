...
public class UnityEngine_WWWWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("LoadFromCacheOrDownload", new LuaCSFunction(LoadFromCacheOrDownload));
		L.RegFunction("LoadImageIntoTexture", new LuaCSFunction(LoadImageIntoTexture));
		L.RegFunction("Dispose", new LuaCSFunction(Dispose));
		L.RegFunction("GetAudioClip", new LuaCSFunction(GetAudioClip));
		L.RegFunction("GetAudioClipCompressed", new LuaCSFunction(GetAudioClipCompressed));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_WWW));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("assetBundle", new LuaCSFunction(get_assetBundle), null);
		L.RegVar("bytes", new LuaCSFunction(get_bytes), null);
		L.RegVar("bytesDownloaded", new LuaCSFunction(get_bytesDownloaded), null);
		...
		L.RegVar("responseHeaders", new LuaCSFunction(get_responseHeaders), null);
		L.RegVar("text", new LuaCSFunction(get_text), null);
		L.RegVar("texture", new LuaCSFunction(get_texture), null);
		L.RegVar("textureNonReadable", new LuaCSFunction(get_textureNonReadable), null);
		L.RegVar("threadPriority", new LuaCSFunction(get_threadPriority), new LuaCSFunction(set_threadPriority));
		L.RegVar("uploadProgress", new LuaCSFunction(get_uploadProgress), null);
		L.RegVar("url", new LuaCSFunction(get_url), null);
		L.RegVar("keepWaiting", new LuaCSFunction(get_keepWaiting), null);
		L.EndClass();
	}
	...
	static int _CreateUnityEngine_WWW(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				string arg0 = ToLua.CheckString(L, 1);
				byte[] arg1 = ToLua.CheckByteBuffer(L, 2);
				System.Collections.Generic.Dictionary<string,string> arg2 = (System.Collections.Generic.Dictionary<string,string>)ToLua.CheckObject(L, 3, TypeTraits<System.Collections.Generic.Dictionary<string,string>>.type);
	...
	static int GetAudioClip(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
				bool arg1 = LuaDLL.luaL_checkboolean(L, 3);
				UnityEngine.AudioType arg2 = (UnityEngine.AudioType)ToLua.CheckObject(L, 4, TypeTraits<UnityEngine.AudioType>.type);
	...
	static int GetAudioClipCompressed(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				UnityEngine.WWW obj = (UnityEngine.WWW)ToLua.CheckObject<UnityEngine.WWW>(L, 1);
				bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
				UnityEngine.AudioType arg1 = (UnityEngine.AudioType)ToLua.CheckObject(L, 3, TypeTraits<UnityEngine.AudioType>.type);
